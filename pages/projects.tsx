        ...
        >
            <div className='grid lg:grid-cols-2 mt-2 md:grid-cols-2 sm:grid-cols-1 gap-4'>
                <ProjectTile
                    ...
                    description={['Developed a dashboard for my IBM team to do CRUD on our internal website containing markdown articles.']}
                    skills={['React', 'Node', 'Linux', 'API', 'CSS']}
                    dates='Mar 2023 - May 2023'
                />
                <ProjectTile
                    title='5G System Status UI'
                    description={['Developed a draggable flowchart UI showing internal IBM 5G systems and their JSON data as tables.']}
                    skills={['React', 'Node', 'Linux', 'API', 'CSS']}
                    dates='Apr 2022 - Jun 2022'
                />
                <ProjectTile
                    title='UT Dallas Senior Design Project'
                    description={['My Team was tasked with building a website for students to find tutors and schedule appointments.']}
                    skills={[
                        'React.js',
                        'Next.js',
                        'Prisma',
